...
@Composable
fun ConnectionRow(modifier: Modifier = Modifier, phoneName: String, description: String ,onClick:()->Unit) {
    Row(
        modifier = modifier
            .fillMaxWidth(0.8f)
        ...
        Icon(
            imageVector = Icons.Sharp.PhoneIphone,
        ...
        Column(
            ...
            Text(text = "CONNECT", modifier = Modifier.clickable { onClick() })
        }
    }
}